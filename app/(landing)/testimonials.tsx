    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[800px] text-muted-foreground md:text-xl">
              See how QuickBoarder is transforming product management for online retailers.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            />
            <TestimonialCard
              quote="Processing unorganized product images was always a pain point for us. QuickBoarder solved that completely."
          ...
          <div className="mt-16 rounded-lg border bg-muted/30 p-8">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-2xl font-medium">4.9/5 average rating from 500+ customers</p>
            </div>
          </div>
        </section>
  )
