...
import CorneredBox from "../corner-border";
...
export function ChannelConnect({ connections }: ChannelConnectProps) {
  return (
    <CorneredBox className="flex items-center justify-start border rounded-xl p-4 h-[200px] w-full gap-8 overflow-hidden mb-4">
      <div className="flex items-center justify-start h-[200px] w-full overflow-hidden pb-8">
